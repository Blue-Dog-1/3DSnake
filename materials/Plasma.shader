...
Shader "Ultimate 10+ Shaders/Plasma"
{
    Properties
    {
        ...
        _EmissIntensity ("Emission Intensity", Range(0,1)) = 0.5
        _AlfaIntensity ("Emission Intensity", Range(0,1)) = 0.5
        _ColorEmiss ("Color", Color) = (1,1,1,1)
    ...
    SubShader
    {
        ...
        void surf (Input IN, inout SurfaceOutputStandard o)
        {
            ...
            emiss = tex2D (_NoiseTex, IN.uv_NoiseTex) * _ColorEmiss * _EmissIntensity;
            o.Emission = emiss.rgb;
            o.Albedo = pixel.rgb;
            

            o.Normal = tex2D(_Normal, IN.uv_Normal);
            
            o.Alpha = pixel.a * _AlfaIntensity;
        }
        ENDCG
    }
    FallBack "Diffuse"
